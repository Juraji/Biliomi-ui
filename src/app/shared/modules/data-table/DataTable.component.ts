...
import {
    CellOutletRowContext,
    CollectionViewer,
    CollectionViewerUpdate,
    ColumnSetup,
    TableColumnsSetup,
...
export class DataTableComponent<T> implements CollectionViewer, OnInit, OnDestroy, AfterContentInit, AfterContentChecked {
    ...
    @Input("lockPagination")
    public lockPagination: boolean = false;
    ...
    private readonly _viewChange: Observable<CollectionViewerUpdate>;
    ...
    constructor(differs: IterableDiffers, changeDetectorRef: ChangeDetectorRef) {
        ...
        this._viewChange = new BehaviorSubject<CollectionViewerUpdate>({start: 0, end: Number.MAX_VALUE});
    }
