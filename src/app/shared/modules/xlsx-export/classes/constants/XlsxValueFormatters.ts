...
import {BinaryOperator, Dictionary, Function} from "../../../tools/FunctionalInterface";
...
export const XLSX_FORMATTER_LIST_REDUCTION: Function<BinaryOperator<any, any>, XlsxFormatterFunction> = (bo: BinaryOperator<any, any>) => (o: any[]) => o.reduce(bo);
